...
<body>
    ...
    <div class="menu">
        <li class="active"><a href="http://localhost/project2020/stores/stores.php">View</a></li>
        ...
        <?php
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    echo "<tr><td><a href='http://localhost/project2020/stores/store_phones.php?id=".$row["store_id"]."'>" . $row["store_id"]. "</a></td><td>" . $row["operating_hours"] . "</td><td>"
                    . $row["square_meters"]. "</td><td>" . $row["street"] ."</td><td>".$row["number"].
                    "</td><td>" .$row["city"]. "</td><td>" .$row["postal_code"]. "</td></tr>";
                }
            echo "</table>";
            } 
            else { 
