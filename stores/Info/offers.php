...
<body>
    <div class="welcome">
        <h1><em>Products in each store <em></h1>
        </div>
    <nav>
        <ul class="first_bar">
            <li><a href="#">Menu</a>
                <ul class="nav-links">
                    ...
                    <li class="active"><a href='http://localhost/project2020/stores/Info/offers.php'>Offers</a></li>
    ...
    <table>
        ...
        <?php
            ...
            $sql = "SELECT * FROM offers ORDER BY store_id";
            $result = $conn->query($sql);
            if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
                    echo "<tr><td>" . $row["aisle"]. "</td><td>" . $row["shelf"] . "</td><td>"
                    . $row["barcode"]. "</td><td>" . $row["store_id"] ."</td></tr>";
                }
            echo "</table>";
            } 
            else { 
