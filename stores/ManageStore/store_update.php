...
<body>
    ...
    <div class="menu">
        ...
        <li class="active"><a href="http://localhost/project2020/stores/ManageStore/store_update.php">Update</a></li>
        ...
        <?php
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    <a href='http://localhost/project2020/stores/ManageStore/upd_form.php?id=".$row['store_id']."&sqr=".$row['square_meters']."
                    &str=".$row['street']."&num=".$row['number']."&city=".$row['city']."&post=".$row['postal_code']."'>Update</a></td></tr>";
                }
            echo "</table>";
            } 
            else { 
