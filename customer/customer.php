...
<body>
    ...
    <div class="menu">
        <li class="active"><a href="http://localhost/project2020/customer/customer.php">View</a></li>
        ...
        <?php
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    . $row["date_of_birth"]. "</td><td>" . $row["street"] ."</td><td>" . $row["number"] ."</td><td>". $row["city"] ."</td><td>".  $row["postal_code"] ."</td><td>". $row["points"] ."</td><td>". $row["family_members"] ."</td><td>"
                    . $row["pet"] ."</td></tr>";
                }
            echo "</table>";
            } 
