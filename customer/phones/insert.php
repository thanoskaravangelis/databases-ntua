...
<body>
    ...
    <div class="back">
			<a href="http://localhost/project2020/customer/phones/customer_phones.php"><button type="button" class="back">Back</button></a>
    </div>
    <br><br><br>

    <div class="title">
        <h2>Please insert the new phone number:</h2> 
    </div>    
    <?php
        $old=$_GET['p'];
    ...
    <form action="insertit.php" method="post" name="user">
        <input type="hidden" name="id" value= "<?php echo $old ?>">    
