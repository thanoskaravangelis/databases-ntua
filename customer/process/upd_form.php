...
<body>
    ...
    <div class="menu">
        ...
        <li class="active"><a href="http://localhost/project2020/customer/process/upd_form.php">Update</a></li>
        ...
        <?php
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    . $row["date_of_birth"]. "</td><td>" . $row["street"] ."</td><td>" . $row["number"] ."</td><td>". $row["city"] ."</td><td>".  $row["postal_code"] ."</td><td>". $row["points"] ."</td><td>". $row["family_members"] ."</td><td>&nbsp"
                    . $row["pet"] ."</td><td><a href='http://localhost/project2020/customer/process/update.php?id=".$row["card_number_ID"]."&str=".$row["street"]."
                    &num=".$row["number"]."&city=".$row["city"]."&pc=".$row["postal_code"]."&points=".$row["points"]."&fam=".$row["family_members"]."&pet=".$row["pet"]."'> Update</a></td></tr>";
                }
            echo "</table>";
            } 
            else { 
