        ...
        <ul class="first_bar">
            <li><a href="#">Menu</a>
                <ul class="nav-links">
                    ...
                    <li class="active"><a href='http://localhost/project2020/transactions/transactions.php'>Transactions</a></li>
        ...
        <?php
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<tr><td><a href='http://localhost/project2020/transactions/contains.php?x=".$x."'>" . $row["transaction_id"]. "</a></td><td>" . $row["date_time"] . "</td><td>"
