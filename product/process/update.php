...
<body>
    ...
    <div class="menu">
        ...
        <li class="active"><a href="http://localhost/project2020/product/process/update.php">Update</a></li>
    ...
    <?php
        ...
        // output data of each row
            while($row = $result->fetch_assoc()) {
                ...
                <a href='http://localhost/project2020/product/process/upd_form.php?bar=".$row["barcode"]."&pr=".$row["price"]."&br=".$row["brand_name"]."&n=".$row["name"]."&pc=".$row["product_category_prod_cat_id"]."'>Update</a></td></tr>";
            }
            echo "</table>";
        } 
        else { 
