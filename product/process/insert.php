...
<body>
    ...
    <form action="insertit.php" method="post" name="user">
        ...
        <input type="text" name="barcode" class="form-control" placeholder ="Barcode" required><br>
        <input type="float" name="price" class="form-control" placeholder ="price" required><br>
        <input type="text" name="brand" class="form-control" placeholder ="Brand Name? (Yes/No)" required><br>
        <input type="int" name="prod_cat" class="form-control" placeholder ="Product Category ID" required><br>
