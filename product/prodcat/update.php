...
<body>
    <div class="welcome">
        <h1><em> Product Categories <em></h1>
    </div>
    <nav>
        <ul class="first_bar">
            <li><a href="#">Menu</a>
                <ul class="nav-links">
                    ...
                    <li  class="active"><a href="http://localhost/project2020/product/product_cat.php">Prod.Categories</a></li>
    ...
    <div class="title">
        <h2>Please Fill the updated Category's Information:</h2> 
    </div>    
    <?php
        $n=$_GET['n'];
        $id=$_GET['pc'];
    ...
    <form action="updit.php" method="post" name="user">
        ...
        <input type="text" name="name" class="form-control" placeholder ="Product Category Name: Previous Name <?php echo $n?>"><br>
        <input type="text" name="pid" class="form-control" placeholder ="Product Category ID: Previous ID: <?php echo $id?>"><br>
