...
<body>
    ...
    <?php
        ...
        if (isset($_GET['cat'])){
            ?><div class="back">
			        <a href="http://localhost/project2020/product/product_cat.php"><button type="button" class="back">Back</button></a>
                 </div><?php
            $cat=$_GET['cat'];
            $sql = "SELECT * FROM product WHERE product_category_prod_cat_id='$cat'";   
        }
        else{
        ...
        <div class="menu">
            <li class="active"><a href="http://localhost/project2020/product/product.php">View</a></li>
            ...
            <li><a href="http://localhost/project2020/product/process/delete.php">Delete</a></li>
        </div> 
        ...
        // output data of each row
            while($row = $result->fetch_assoc()) {
                $x=$row["barcode"];
                echo "<tr><td><a href='http://localhost/project2020/older_prices/older_prices.php?bar=".$x."'>" . $row["barcode"]. "</a></td><td>" . $row["price"] . "</td><td>"
                . $row["brand_name"]. "</td><td>" . $row["name"] ."</td><td>" . $row["product_category_prod_cat_id"] . "</td></tr>";
            }
            echo "</table>";
        } 
        else { 
